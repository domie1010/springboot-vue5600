    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单位" prop="yonghuDanwei">
                       <el-input v-model="ruleForm.yonghuDanwei"
                                 placeholder="单位" clearable  :readonly="ro.yonghuDanwei"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="单位" prop="yonghuDanwei">
                           <el-input v-model="ruleForm.yonghuDanwei"
